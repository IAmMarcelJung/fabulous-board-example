...
static inline uint32_t ctrl_reset_soc_rst_replace(uint32_t oldword,
                                                  uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
...
static inline uint32_t ctrl_reset_cpu_rst_replace(uint32_t oldword,
                                                  uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
...
flash_core_master_phyconfig_len_extract(uint32_t oldword) {
    uint32_t mask = ((1 << 8) - 1);
    return ((oldword >> 0) & mask);
}
...
static inline uint32_t
flash_core_master_phyconfig_len_replace(uint32_t oldword,
                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 8) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
static inline void flash_core_master_phyconfig_len_write(uint32_t plain_value) {
    ...
    uint32_t newword =
        flash_core_master_phyconfig_len_replace(oldword, plain_value);
...
static inline uint32_t
flash_core_master_phyconfig_width_extract(uint32_t oldword) {
    uint32_t mask = ((1 << 4) - 1);
...
static inline uint32_t
flash_core_master_phyconfig_width_replace(uint32_t oldword,
                                          uint32_t plain_value) {
    uint32_t mask = ((1 << 4) - 1);
    return (oldword & (~(mask << 8))) | (mask & plain_value) << 8;
}
static inline void
flash_core_master_phyconfig_width_write(uint32_t plain_value) {
    uint32_t oldword = flash_core_master_phyconfig_read();
    uint32_t newword =
        flash_core_master_phyconfig_width_replace(oldword, plain_value);
    flash_core_master_phyconfig_write(newword);
}
#define CSR_FLASH_CORE_MASTER_PHYCONFIG_MASK_OFFSET 16
#define CSR_FLASH_CORE_MASTER_PHYCONFIG_MASK_SIZE 8
static inline uint32_t
flash_core_master_phyconfig_mask_extract(uint32_t oldword) {
    uint32_t mask = ((1 << 8) - 1);
...
static inline uint32_t
flash_core_master_phyconfig_mask_replace(uint32_t oldword,
                                         uint32_t plain_value) {
    uint32_t mask = ((1 << 8) - 1);
    return (oldword & (~(mask << 16))) | (mask & plain_value) << 16;
}
static inline void
flash_core_master_phyconfig_mask_write(uint32_t plain_value) {
    uint32_t oldword = flash_core_master_phyconfig_read();
    uint32_t newword =
        flash_core_master_phyconfig_mask_replace(oldword, plain_value);
    flash_core_master_phyconfig_write(newword);
}
...
static inline uint32_t
flash_core_master_status_tx_ready_extract(uint32_t oldword) {
    uint32_t mask = ((1 << 1) - 1);
    return ((oldword >> 0) & mask);
}
...
static inline uint32_t
flash_core_master_status_rx_ready_extract(uint32_t oldword) {
    uint32_t mask = ((1 << 1) - 1);
    return ((oldword >> 1) & mask);
}
...
static inline uint32_t spi_master_control_start_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t spi_master_control_length_replace(uint32_t oldword,
                                                         uint32_t plain_value) {
    uint32_t mask = ((1 << 8) - 1);
    return (oldword & (~(mask << 8))) | (mask & plain_value) << 8;
}
...
static inline uint32_t spi_master_cs_sel_replace(uint32_t oldword,
                                                 uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t spi_master_cs_mode_replace(uint32_t oldword,
                                                  uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 16))) | (mask & plain_value) << 16;
}
...
static inline uint32_t spi_master_loopback_mode_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t timer0_ev_pending_zero_replace(uint32_t oldword,
                                                      uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t timer0_ev_enable_zero_replace(uint32_t oldword,
                                                     uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t uart_ev_pending_tx_replace(uint32_t oldword,
                                                  uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t uart_ev_pending_rx_replace(uint32_t oldword,
                                                  uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 1))) | (mask & plain_value) << 1;
}
...
static inline uint32_t uart_ev_enable_tx_replace(uint32_t oldword,
                                                 uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t uart_ev_enable_rx_replace(uint32_t oldword,
                                                 uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 1))) | (mask & plain_value) << 1;
}
...
static inline uint32_t user_irq_0_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_0_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_1_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_1_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_2_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_2_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_3_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_3_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_4_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_4_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_5_ev_pending_i0_replace(uint32_t oldword,
                                                        uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
...
static inline uint32_t user_irq_5_ev_enable_i0_replace(uint32_t oldword,
                                                       uint32_t plain_value) {
    uint32_t mask = ((1 << 1) - 1);
    return (oldword & (~(mask << 0))) | (mask & plain_value) << 0;
}
