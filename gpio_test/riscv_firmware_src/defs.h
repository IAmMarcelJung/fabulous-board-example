...
#define reg_timer0_config                                                      \
    (*(volatile uint32_t *)CSR_TIMER0_EN_ADDR) // this is enable not config
...
#define reg_spimaster_control                                                  \
    (*(volatile uint32_t *)CSR_SPI_MASTER_CONTROL_ADDR)
...
#define reg_spimaster_clk_divider                                              \
    (*(volatile uint32_t *)CSR_SPI_MASTER_CLK_DIVIDER_ADDR)
...
#define reg_user4_irq_en                                                       \
    (*(volatile uint32_t *)CSR_USER_IRQ_4_EV_ENABLE_ADDR) // mprj[7]
