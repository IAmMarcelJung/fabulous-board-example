...
static void execute_bit_op_for_gpio(uint8_t pin, BitOpFunctionPointer bit_op_ptr);
 ...
 */
static void execute_bit_op_for_gpio(uint8_t pin, BitOpFunctionPointer bit_operation)
{
    if (BITS_IN_WORD > pin)
    {
